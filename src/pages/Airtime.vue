  ...
  <div class="container bg-white py-3">
    ...
    <div class="d-flex over-x mb-3">
      <div @click="selectedContact = '09054246419'" class="recent px-3 me-2 d-flex justify-content-center align-items-center">
        <img src="/airtel.png" class="rounded-circle me-2" width="24" />
    ...
    <div class="row">
      ...
      <div class="col-12 mb-2">
        <label class="form-label text-small text-80">Airtime Type:</label>
        <div class="position-relative login-form">
          <select v-model="type" class="form-control form-control-lg form-select form-select-lg"
            :class="{ 'filled': type }" aria-label="Airtime Type">
    ...
    <div class="col-12 mb-5">
      ...
      " class="btn btn-primary btn-lg w-100 mt-5" :disabled="(!amount || amount <= 49)"
        :class="{ 'bg-40': (!amount || amount <= 49) }">Proceed</button>
